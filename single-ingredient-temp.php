											...
											<div class="post-info-in">
												<div class="post-info-right left relative">
													<div class="post-info-name left relative">
														<span class="post-info-text"><?php if ( $goal < 2 ) : _e( 'Goal:', 'mvp-text' ); else : _e( 'Goals:', 'mvp-text' ); endif; ?></span> <span class="author-name vcard fn" itemprop="author"><?php $goal = the_terms( $post->ID, 'goal'); echo esc_html( $goal->cat_name ); ?></span>
													</div><!--post-info-name-->
													<div class="post-info-name left relative" style="border-bottom: 0;">
														<span class="post-info-text"><?php _e( 'Tags:', 'mvp-text' ); ?></span> <span class="author-name"><?php $ing_tag = the_terms( $post->ID, 'ing_tag'); echo esc_html( $ing_tag->cat_name ); ?></span>
													</div><!--post-info-date-->
												</div><!--post-info-right-->
											</div><!--post-info-in-->
										</div><!--post-info-out-->
